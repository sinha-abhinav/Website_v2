...
window.Typekit.config = {
  a: '646866',
  dl: 'AAAAVwAAAAoWFGWMPr78TgB8Th4',
  fi: [5474, 175, 25136, 173, 139, 5475, 140, 10879, 10881, 10880, 10882],
  fc: [
    {
      id: 5474,
      family: 'proxima-nova',
      src:
        'https://use.typekit.net/af/cebe0e/00000000000000003b9b3060/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '300',
        style: 'normal',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'proxima-nova',
      src:
        'https://use.typekit.net/af/705e94/00000000000000003b9b3062/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '400',
        style: 'normal',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'proxima-nova',
      src:
        'https://use.typekit.net/af/6e816b/00000000000000003b9b3064/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '500',
        style: 'normal',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'proxima-nova',
      src:
        'https://use.typekit.net/af/576d53/00000000000000003b9b3066/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '600',
        style: 'normal',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'proxima-nova',
      src:
        'https://use.typekit.net/af/949f99/00000000000000003b9b3068/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '700',
        style: 'normal',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'proxima-nova',
      src:
        'https://use.typekit.net/af/40ff7f/00000000000000003b9b3061/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '300',
        style: 'italic',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'proxima-nova',
      src:
        'https://use.typekit.net/af/4c4052/00000000000000003b9b3069/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '700',
        style: 'italic',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'futura-pt',
      src:
        'https://use.typekit.net/af/2cd6bf/00000000000000000001008f/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '500',
        style: 'normal',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'futura-pt',
      src:
        'https://use.typekit.net/af/309dfe/000000000000000000010091/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '700',
        style: 'normal',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'futura-pt',
      src:
        'https://use.typekit.net/af/1eb35a/000000000000000000010090/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '500',
        style: 'italic',
        display: 'auto',
    ...
    },
    {
      ...
      family: 'futura-pt',
      src:
        'https://use.typekit.net/af/eb729a/000000000000000000010092/27/{format}{?primer,subset_id,fvd,v}',
      descriptors: {
        weight: '700',
        style: 'italic',
        display: 'auto',
  ...
  fn: [
    ...
    ['i5', 'i7', 'n5', 'n7'],
    'proxima-nova',
    ['i3', 'i7', 'n3', 'n4', 'n5', 'n6', 'n7'],
  ],
  hn: 'use.typekit.net',
  ht: 'tk',
  js: '1.19.2',
  kt: '646866_57d2f8668419c276f91f3b04',
  l: 'typekit',
  ps: 2,
...
/*{"k":"1.19.2","auto_updating":true,"last_published":"2017-10-23 13:28:59 UTC"}*/
